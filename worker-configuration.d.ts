/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: db8423c03379bea3084b0b2d83cc2d00)
// Runtime types generated with workerd@1.20260820.1 2026-08-20
interface __BaseEnv_Env {
	ASSETS: Fetcher;
	MY_DURABLE_OBJECT: DurableObjectNamespace<import("./web/index").MyDurableObject>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./web/index");
